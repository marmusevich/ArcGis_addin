...
namespace CadastralReference
{
    public partial class frmPrevImage : Form
    {
        private void btnSaveAs_Click(object sender, EventArgs e)
        {
            ...
            {
                // сообщить про ошибку
                Logger.Write(ex, string.Format("На могу сохранить изображение в '{0}'", sfd.FileName));
                GeneralApp.ShowErrorMessage(string.Format("На могу сохранить изображение в '{0}'", sfd.FileName));
            }
        }
        ...
        private void frmPrevImage_Load(object sender, EventArgs e)
        {
            ...
            //this.pbPrev.Image = WorkCadastralReference.GetImageFromArcGis();
        ...
        private void prntPprintDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            e.Graphics.DrawImage(pbPrev.Image, e.MarginBounds); //Картинка на печать
        }
        private void prntPprintDocument_EndPrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
