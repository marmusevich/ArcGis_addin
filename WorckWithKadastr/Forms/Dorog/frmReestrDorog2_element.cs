...
namespace WorckWithReestr
{
    ...
    public partial class frmReestrDorog2_element : frmBaseSpr_element
    {
        //---------------------------------------------------------------------------------------------------------------------------------------------
        #region  types
        //---------------------------------------------------------------------------------------------------------------------------------------------
        ...
        #region  form events
        //---------------------------------------------------------------------------------------------------------------------------------------------
        public frmReestrDorog2_element() : base()
        {
            InitializeComponent();
        }

        public frmReestrDorog2_element(int _objectID, EditMode _editMode)
        ...
        private void frmReestrDorog2_element_Load(object sender, EventArgs e)
        {
            switch (editMode)
            {
                case EditMode.ADD:
...
{
    public partial class frmKategoriiDorog_element : frmBaseSpr_element
    {
        //---------------------------------------------------------------------------------------------------------------------------------------------
        #region  types
        //---------------------------------------------------------------------------------------------------------------------------------------------
