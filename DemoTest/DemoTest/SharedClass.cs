...
namespace DemoTest
{
    class SharedClass
    {
        ...
        //TO DO:
        // возможно синглитон для подключения что б не переподключатся - после тестов, пока вроде нормально, быстро, тормоз только первый раз
        // возможно пераметры сервера/экземпляра вынести или в ресурсы, внешний файл или еще как
