...
namespace WorckWithCadastr_V6
{
    public partial class frmRej_Bud_Adr_list : frmBase_list
    {
        ...
        {
            Form frm = new frmRej_Bud_Adr_list(false, filteredString);
            frm.Show();
            frm.Activate();
        }
        ...
        public frmRej_Bud_Adr_list() : base()
        {
            InitializeComponent();
        }
        
        public frmRej_Bud_Adr_list(bool isSelectMode = false, string filteredString = "") : base(isSelectMode, filteredString)
        {
            InitializeComponent();
