...
namespace WorckWithCadastr_V6
{
    public partial class frmObj_Scl_Sft_Ecn_list : frmBase_list
    {
        ...
        {
            Form frm = new frmObj_Scl_Sft_Ecn_list(false, filteredString);
            frm.Show();
            frm.Activate();
        }
        ...
        public frmObj_Scl_Sft_Ecn_list() : base()
        {
            InitializeComponent();
        }
        
        public frmObj_Scl_Sft_Ecn_list(bool isSelectMode = false, string filteredString = "") : base(isSelectMode, filteredString)
        {
            InitializeComponent();
