...
namespace WorckWithCadastr_V6
{
    public partial class frmRej_Adm_Raj_Mis_list : frmBase_list
    {
        ...
        {
            Form frm = new frmRej_Adm_Raj_Mis_list(false, filteredString);
            frm.Show();
            frm.Activate();
        }
        ...
        public frmRej_Adm_Raj_Mis_list() : base()
        {
            InitializeComponent();
        }
        
        public frmRej_Adm_Raj_Mis_list(bool isSelectMode = false, string filteredString = "") : base(isSelectMode, filteredString)
        {
            InitializeComponent();
